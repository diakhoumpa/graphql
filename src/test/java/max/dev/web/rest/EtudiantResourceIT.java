...
import max.dev.IntegrationTest;
...
class EtudiantResourceIT {
    ...
    public static Etudiant createEntity(EntityManager em) {
        Etudiant etudiant = new Etudiant().adresse(DEFAULT_ADRESSE).nom(DEFAULT_NOM).prenom(DEFAULT_PRENOM).age(DEFAULT_AGE);
        return etudiant;
    }
    ...
    public static Etudiant createUpdatedEntity(EntityManager em) {
        Etudiant etudiant = new Etudiant().adresse(UPDATED_ADRESSE).nom(UPDATED_NOM).prenom(UPDATED_PRENOM).age(UPDATED_AGE);
        return etudiant;
    }
    ...
    void putExistingEtudiant() throws Exception {
        ...
        updatedEtudiant.adresse(UPDATED_ADRESSE).nom(UPDATED_NOM).prenom(UPDATED_PRENOM).age(UPDATED_AGE);
    ...
    void fullUpdateEtudiantWithPatch() throws Exception {
        ...
        partialUpdatedEtudiant.adresse(UPDATED_ADRESSE).nom(UPDATED_NOM).prenom(UPDATED_PRENOM).age(UPDATED_AGE);
